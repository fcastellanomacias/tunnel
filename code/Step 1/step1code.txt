...
# and whether they are alternating or nonalternating. Creates the list
...
# Outputs a csv file called step1output.csv containing knotlist.
with open('step1output.csv', 'w') as filecsv:
